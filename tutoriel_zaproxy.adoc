...
Il faut maintenant trouver l'adresse IP de la machine hôte sur ce réseau virtuel.
...
et l'application à analyser accessible à l'adresse: http://192.168.56.1/bodgeit.
